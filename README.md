...
| `/api/loteproducaos` | GET / POST / PUT / DELETE | CRUD de LoteProducao |
| `/api/inspecaoqualidades` | GET / POST / PUT / DELETE | CRUD de InspecaoQualidade |
| `/api/naoconformidades` | GET / POST / PUT / DELETE | CRUD de NaoConformidade |
